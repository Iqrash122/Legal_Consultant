...
const Litigation = () => {
  ...
  useEffect(() => {
    if (data) setLitigations(data?.data);
  }, [data]);
      ...
      {litigations &&
        litigations
          ...
          ?.map((item: Record<string, any>, index: number) => (
            <Link
              to={`/litigation/${item.id}`}
              data-aos="zoom-in-up"
              className="relative group hover:scale-105 h-max overflow-hidden transition duration-300"
              key={index}
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-3">
                <button className="bg-white group-hover:bg-[#e88b28] group-hover:text-white transition duration-300  px-6 py-3 w-full text-center rounded-t-3xl font-bold hover:shadow-lg transition-shadow duration-300">
                  {item.title}
                </button>
              </div>
            </Link>
          ...
          >
            <div className="image  h-[400px] overflow-hidden ">
              <Skeleton
                ...
                containerClassName="h-full block w-full"
              />
            </div>
          </div>
        ))}
    ...
    <div className="flex flex-wrap justify-center min-[645px]:p-12 gap-6">
      {data?.data &&
        data.data.map((item: Record<string, any>, index: number) => (
          <div
            data-aos="zoom-in-up"
            className="relative w-[450px] max-[1126px]:w-full bg-white group hover:scale-105 h-max overflow-hidden transition duration-300 p-9"
            key={index}
          >
            <div className="">
...
const HomeSlide = () => {
  ...
  return <Slides slides={reviews || slides} />;
};
    ...
    <div>
      ...
      <section className="p-24 max-[645px]:p-12">
        <div className="text-center">
          <h1
            data-aos="zoom-in-up"
            className="text-6xl max-[645px]:mb-3 max-[645px]:text-4xl font-light"
          >
            Our Services
          </h1>
        </div>
        ...
        <div className="grid grid-cols-12 max-[1100px]:grid-cols-8 max-[645px]:grid-cols-4 ">
          <div className="col-span-4 text-center">
            <div
              data-aos="zoom-in-up"
              className="details pt-12 max-[645px]:pt-6"
            >
              <div className="font-bold text-2xl max-[645px]:text-xl">
                Solicitor's Work
              </div>
            ...
            <div data-aos="zoom-in-up" className="details text-center">
              ...
              <div className="mt-3 flex justify-center gap-x-3 flex-wrap max-[1100px]:text-sm">
                ...
                <div className="my-1.5">
                  • Trials , Defense and Prosecution of claims
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-12 max-[700px]:grid-cols-6">
          ...
          <div className="col-span-6 p-24 pl-0 max-[845px]:p-12 max-[845px]:pl-0 max-[700px]:p-12 flex items-center ">
            <div className="max-[700px]:text-center">
              <h1 data-aos="zoom-in-up" className="text-4xl">
                Our Mission
              </h1>
              <p
                data-aos="zoom-in-up"
                className="mt-1.5 leading-relaxed text-lg"
              >
                Our Mission is to be a trusted legal partner for individuals,
                businesses, and organizations. Also to navigate the complexities
                of the legal landscape on behalf of our clients, ensuring they
                receive sound legal advice, strategic counsel, and assertive
                advocacy.
              </p>
              <Link to={"/contact"}>
                <button
                  data-aos="zoom-in-up"
                  className="bg-white px-6 py-3 mt-6 text-lg text-neutral-900 hover:shadow-lg transition-shadow duration-300"
                >
                  Get in Touch
                </button>
              </Link>
      ...
      <section className="p-24 max-[845px]:p-12">
        <div className="text-center flex items-center justify-between gap-3 max-[545px]:block">
          <div className="">
            <h1 data-aos="zoom-in-up" className="text-4xl font-light">
              Areas of Litigation
            </h1>
          </div>
          ...
          <p
            data-aos="zoom-in-up"
            className="max-w-[400px] max-[990px]:hidden mx-auto my-3 text-right"
          >
            Our seasoned lawyers are trained experts in the following areas of
            litigation
          </p>
          ...
          <Link to={"/litigations"}>
            <button
              data-aos="zoom-in-up"
              className="px-6 py-4 bg-[#e88b28] text-white capitalize mt-3 hover:shadow-lg transition-shadow duration-300 "
            >
